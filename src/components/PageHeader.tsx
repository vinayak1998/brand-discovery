        ...
        <div className="flex items-start justify-between gap-3 sm:gap-4">
          <div className="flex items-start gap-3 sm:gap-4 flex-1">
            <div className="flex-shrink-0">
              <img src={wishLinkLogo} alt="Wishlink" className="h-8 sm:h-12 w-auto object-contain" />
            </div>
            ...
            <div className="flex-1">
              ...
              <p
                className={`text-primary-foreground/90 ${pageContext === "products" ? "text-sm sm:text-lg" : "text-base sm:text-xl"} mb-1 sm:mb-2`}
              >
